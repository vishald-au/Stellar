...
export namespace ExpoRouter {
  type StaticRoutes = `/` | `/(tabs)` | `/_sitemap` | `/cart` | `/home` | `/list` | `/profile`;
  type DynamicRoutes<T extends string> = `/product/${SingleRoutePart<T>}`;
  type DynamicRouteTemplate = `/product/[id]`;
